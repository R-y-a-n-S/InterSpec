...
static
#endif
real *ExpandFS(cThis *t, cBounds *b, real *g, real *x)
{
...
static
#endif
void Sample(This *t, void *voidregion)
{
  TYPEDEFREGION;
  TYPEDEFSET;
